...
`;document.getElementById("row-input").addEventListener("input",e=>h(e.target.value));document.getElementById("shuffle-btn").addEventListener("click",e=>p());document.getElementById("sort-btn").addEventListener("click",e=>L(document.getElementById("sorts").value));document.getElementById("reset-btn").addEventListener("click",e=>w());
